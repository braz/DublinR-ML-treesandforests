# File-Name:				1-Marketing-Survey-Dataset.R
# Date:						2013-09-23
# Author:					Eoin Brazil
...
itemFrequencyPlot(marketing.transactions, support = 0.1, cex.names=0.8)
...
plot(marketing.subrules, method="graph", control=list(engine="graphviz",type="items"))

# save rules in graph format
saveAsGraph(marketing.subrules, file=(paste(datapath, "marketing-subrules.graphml", sep="")))